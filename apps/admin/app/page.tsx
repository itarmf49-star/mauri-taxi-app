    ...
    <div className="min-h-screen">
      ...
      <main className="p-4 max-w-6xl mx-auto">
        <section className="mb-4">
          <h2 className="text-lg font-bold text-chinguetti-mosque mb-2">{t.gpsTracking}</h2>
          <AdminMap rides={MOCK_RIDES} drivers={MOCK_DRIVERS} height="350px" />
        </section>

        <section className="bg-white/90 rounded-xl p-4 shadow-lg border border-chinguetti-sand">
          <h2 className="text-lg font-bold text-chinguetti-mosque mb-3">{t.allRides}</h2>
